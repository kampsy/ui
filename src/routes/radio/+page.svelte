...
{#snippet error()}
	<Row>
		<h1
			class="first-letter:capitalize text-kui-light-gray-1000 dark:text-kui-dark-gray-1000 text-[24px] lg:text-[40px] font-semibold leading-8 llg:leading-12 tracking-[-0.96px] lg:tracking-[-2.4px] mb-3"
		>
			radio
		</h1>
		<p
