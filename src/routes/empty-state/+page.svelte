...
{#snippet emptyState()}
	<Row>
		...
		>
			Fill spaces when no content has been added yet, or is temporarily empty due to the nature
			of the feature and should be designed to prevent confusion.
		</p>
	</Row>
{/snippet}
...
{#snippet defaultEmptyState()}
	<Row>
		<LinkH2 href="/empty-state#default" aria-label="default"
			>Empty state Design framework</LinkH2
		>
		<p
		...
		>
			When designed thoughtfully, empty states become an essential part of a smooth user
		...
		<Text size={16} class="mt-2 xl:mt-4">
			- Educational <span class="text-kui-light-gray-900 dark:text-kui-dark-gray-900">
				- Launch a contextual onboarding flow to gain deeper understanding about that area of
				the app</span
			></Text
		>
		<Text size={16} class="mt-2 xl:mt-4">
			- Guide <span class="text-kui-light-gray-900 dark:text-kui-dark-gray-900">
				- Starter content that allows users to interact with data and learn the system by
...
{#snippet informational()}
	<Row>
		...
		<p
			class="mt-2 xl:mt-4 first-letter:capitalize text-kui-light-gray-900 dark:text-kui-dark-gray-900 text-[16px] font-normal leading-6"
		>
			Help users by clearly explaining the benefit and utility of a product or feature, with a
			call to action and link to more information to help users progress.
		</p>
		<p
			class="mt-2 xl:mt-4 first-letter:capitalize text-kui-light-gray-900 dark:text-kui-dark-gray-900 text-[16px] font-normal leading-6"
		>
			...
			states will include a call to action.
		</p>
		<div class="mt-4 xl:mt-7">
			{#snippet demo()}
				<EmptyState.Root
