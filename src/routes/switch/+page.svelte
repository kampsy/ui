...
{#snippet demoAndCode(demo: Snippet, code: string)}
	<div
		class="bg-kui-light-bg dark:bg-kui-dark-bg border border-kui-light-gray-200 dark:border-kui-dark-gray-400 rounded-lg"
	>
...
{#snippet sizes()}
	<Row>
		...
		<div class="mt-4 xl:mt-7">
			...
			{/snippet}
			{@render demoAndCode(demo, switchSize)}
		</div>
	</Row>
{/snippet}
...
{#snippet fullWidth()}
	<Row>
		...
		<div class="mt-4 xl:mt-7">
			...
			{/snippet}
			{@render demoAndCode(demo, switchFullWidth)}
		</div>
	</Row>
{/snippet}
...
{#snippet icon()}
	<Row>
		...
		<div class="mt-4 xl:mt-7">
			...
			{/snippet}
			{@render demoAndCode(demo, switchIcon)}
		</div>
	</Row>
{/snippet}
