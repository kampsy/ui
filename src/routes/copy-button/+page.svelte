...
{#snippet defaultCopyButton()}
	<Row>
		<LinkH2 href="/copy-button#default" aria-label="default">default</LinkH2>
		<div class="mt-4 xl:mt-7">
			{#snippet demo()}
				<CopyButton label="Copy text" textToCopy="lipsum" />
			{/snippet}
			{@render demoAndCode(demo, copyButtonDefault)}
		</div>
	</Row>
{/snippet}
