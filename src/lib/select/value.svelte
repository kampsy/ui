...
<div class="flex items-center justify-between">
	...
	{#if !rootState.getLoading()}
		...
		<div class="w-[16px] h-[16px] flex items-center justify-center">
			<div
				class="w-[16px] h-[16px] text-kui-light-gray-900 hover:text-kui-light-gray-1000 dark:text-kui-dark-gray-900 dark:hover:text-kui-dark-gray-1000 transform duration-300 {rotate}"
			>
				<ChevronDownSmall />
			</div>
		</div>
