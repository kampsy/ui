...
<div
	class="group cursor-pointer transition duration-150 ease-out hover:ease-in hover:bg-kui-light-gray-200 hover:dark:bg-kui-dark-gray-200 px-[10px] py-[8px] rounded-[8px]"
>
