...
{#snippet mobileSnip()}
	{#if rootState.getIsActive()}
		...
		>
			<div
				class="hide-scrollbar bg-kui-light-bg dark:bg-kui-dark-bg px-3 py-3 rounded-t-[15px] border-t 
				border-kui-light-gray-400 dark:border-kui-dark-gray-400 scroll-smooth overflow-y-auto"
			>
				{@render children()}
			</div>
		</div>
